...
public class YouTubeSqlDb {
    ...
    public class Videos {
         ...
         * @return
         */
        public boolean create(YouTubeSearch video) {
        ...
        public ArrayList<YouTubeSearch> readAll() {
            ...
            while (c.moveToNext()) {
                ...
                list.add(new YouTubeSearch(videoId, title, thumbnailUrl, duration, viewsNumber));
            }
            c.close();
            return list;
        }
