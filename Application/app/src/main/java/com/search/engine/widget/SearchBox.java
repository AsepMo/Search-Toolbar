...
import com.search.engine.animation.ReverseInterpolator;
import com.search.engine.animation.SupportAnimator;
import com.search.engine.animation.ViewAnimationUtils;
import com.search.engine.view.MaterialMenuDrawable.IconState;
import com.search.engine.view.MaterialMenuView;
...
public class SearchBox extends RelativeLayout {
	...
	public SearchBox(final Context context, AttributeSet attrs, int defStyle) {
        ...
        thumbnails.setOnClickListener(new OnClickListener(){
    ...
    /***
     * Set the thumbnails listener
     * @param thumbnailsListener MenuListener
     */
    public void setThumbnailsListener(ThumbnailListener thumbnailListener) {
    ...
    public static class SearchAdapter extends ArrayAdapter<SearchResult> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.search_option, parent, false);
